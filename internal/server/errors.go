...
var (
	...
	errAgentMessageRequired      = errors.New("message is required")
	errAgentNotFound             = errors.New("agent not found")
	errAgentSenderUnknown        = errors.New("message sender is unknown")
	errSessionNoParent           = errors.New("session has no parent")
	errAgentSelfMessage          = errors.New("cannot message the sending session")
