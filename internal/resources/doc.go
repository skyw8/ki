...
// project/global appended system prompt, skills, prompt templates, merged MCP
// configuration, and session-scoped MCP discovery. Loader is owned by a server and
