...
const zh = {
  'settings.title': '设置',
	...
	'settings.extensionsHint': '全局启用或停用 extension。服务启动后加载，运行状态会在此显示。',
  ...
  'cfg.extensionsEmpty': '没有发现 extension。',
	...
	'cfg.configClose': '关闭',
	'cfg.telegram.hint': '填写 Managed Bot 的基础信息；回复模型可单独选择，留空时跟随全局默认模型。',
	'cfg.telegram.botId': 'Managed Bot ID',
	'cfg.telegram.botIdPlaceholder': '例如 8733071196',
	'cfg.telegram.botIdRequired': '请输入 Managed Bot ID。',
	'cfg.telegram.token': 'Bot Token',
	'cfg.telegram.tokenPlaceholder': '输入 Managed Bot Token',
	'cfg.telegram.tokenConfigured': 'Token 已配置，留空保持不变',
	'cfg.telegram.tokenHint': 'Token 不会回显；修改时直接输入新的 Token。',
	'cfg.telegram.tokenRequired': '请输入 Bot Token。',
	'cfg.telegram.model': '回复模型',
	'cfg.telegram.modelHint': 'Telegram 私聊和群组回复都使用此模型。',
	'cfg.telegram.modelDefault': '跟随全局默认模型',
	'cfg.telegram.modelDefaultHint': '使用当前全局默认模型',
	'cfg.telegram.modelCustom': '配置中的模型',
	'cfg.telegram.modelReset': '跟随全局默认',
  'cfg.outline': '本页导航',
  'cfg.hint': '启用状态在设置里改。',
...
const en: Record<MsgKey, string> = {
  'settings.title': 'Settings',
	...
	'settings.extensions': 'Extensions',
	'settings.extensionsHint': 'Enable or disable extensions globally. Runtimes start after the server listens and report their state here.',
	'settings.message': 'Message',
  ...
  'cfg.extensionsEmpty': 'No extensions found.',
	...
	'cfg.telegram.hint': 'Set the Managed Bot basics here. Choose a reply model, or leave it empty to follow the global default.',
	'cfg.telegram.botId': 'Managed Bot ID',
	'cfg.telegram.botIdPlaceholder': 'For example, 8733071196',
	'cfg.telegram.botIdRequired': 'Managed Bot ID is required.',
	'cfg.telegram.token': 'Bot Token',
	'cfg.telegram.tokenPlaceholder': 'Enter the Managed Bot token',
	'cfg.telegram.tokenConfigured': 'Token configured; leave empty to keep it',
	'cfg.telegram.tokenHint': 'The token is never echoed. Enter a new token to replace it.',
	'cfg.telegram.tokenRequired': 'Bot token is required.',
	'cfg.telegram.model': 'Reply model',
	'cfg.telegram.modelHint': 'Both private and group replies use this model.',
	'cfg.telegram.modelDefault': 'Follow global default',
	'cfg.telegram.modelDefaultHint': 'Use the current global default model',
	'cfg.telegram.modelCustom': 'Configured model',
	'cfg.telegram.modelReset': 'Follow global default',
