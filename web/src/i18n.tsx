...
const zh = {
  'settings.title': '设置',
	...
	'settings.mcpHint': '全局启用或停用 MCP server；加载失败会自动停用并提示。下次发送和 Reload 后生效。',
	'settings.extensions': 'Extensions',
	'settings.extensionsHint': '全局启用或停用 extension；加载失败会自动停用并提示。下次发送和 Reload 后生效。',
	...
	'mcp.failed': '加载失败',
	'mcp.reload': 'Reload',
	'mcp.reloadQueued': 'Reload 已排队，将在本轮结束后执行。',
  ...
  'composer.placeholderLoading': '正在加载扩展和 MCP…',
...
const en: Record<MsgKey, string> = {
  'settings.title': 'Settings',
	...
	'settings.mcpHint': 'Enable or disable MCP servers globally; load failures disable them automatically and show a prompt. Takes effect on the next send and after Reload.',
	'settings.extensions': 'Extensions',
	'settings.extensionsHint': 'Enable or disable extensions globally; load failures disable them automatically and show a prompt. Takes effect on the next send and after Reload.',
	'settings.message': 'Message',
	...
	'mcp.changed': 'tool list changed',
	'mcp.failed': 'failed to load',
	'mcp.reload': 'Reload',
	'mcp.reloadQueued': 'Reload queued until this run finishes.',
  ...
  'composer.placeholderLoading': 'Loading extensions and MCP…',
  ...
  'cfg.mcp': 'MCP',
  'cfg.tools': 'Tools',
  'cfg.toolCount': '{n} tools',
  'cfg.mcpEmpty': 'No MCP servers registered.',
  'cfg.extensions': 'Extensions',
