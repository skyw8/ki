...
const zh = {
  'settings.title': '设置',
	...
	'settings.mcpHint': '全局启用或停用 MCP server。下次发送和 Reload 后生效。',
	'settings.extensions': 'Extensions',
	'settings.extensionsHint': '全局启用或停用 extension。下次发送和 Reload 后生效。',
  ...
  'cfg.tools': 'Tools',
  'cfg.toolCount': '{n} 个工具',
  'cfg.mcpEmpty': '没有登记 MCP server。写在 ~/.ki/.mcp.json。',
  'cfg.extensions': 'Extensions',
  'cfg.extensionsEmpty': '没有发现 extension。把 extension.json 放到 KI_HOME/extensions。',
  'cfg.outline': '本页导航',
  'cfg.hint': '启用状态在设置里改。',
...
const en: Record<MsgKey, string> = {
  'settings.title': 'Settings',
	...
	'settings.mcpHint': 'Enable or disable MCP servers globally. Takes effect on the next send and after Reload.',
	'settings.extensions': 'Extensions',
	'settings.extensionsHint': 'Enable or disable extensions globally. Takes effect on the next send and after Reload.',
	'settings.message': 'Message',
  ...
  'cfg.mcpEmpty': 'No MCP servers registered. Add them in ~/.ki/.mcp.json.',
  'cfg.extensions': 'Extensions',
  'cfg.extensionsEmpty': 'No extensions found. Put extension.json in KI_HOME/extensions.',
