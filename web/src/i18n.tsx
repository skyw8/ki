...
const zh = {
  ...
  'cfg.extensionsEmpty': '没有发现 extension。把 extension.json 放到 KI_HOME/extensions 或项目 .ki/extensions。',
  'cfg.outline': '本页导航',
  'cfg.hint': '启用状态在设置里改。',
...
const en: Record<MsgKey, string> = {
  ...
  'cfg.extensions': 'Extensions',
  'cfg.extensionsEmpty': 'No extensions found. Put extension.json in KI_HOME/extensions or the project .ki/extensions.',
